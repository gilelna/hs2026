...
<?php if ($has_video_story): ?>
  <article class="card-one col-span-1 transition-transform hover:-translate-y-1">
    <div class="card-one--bg-pic" style="background-image: url('<?php echo esc_url($img_url); ?>');"></div>
    <div class="absolute inset-0 z-10 w-full h-full"
      style="background: linear-gradient(180deg, rgba(0,0,0,0) 30%, rgba(0,0,0,0.8) 100%);"></div>
